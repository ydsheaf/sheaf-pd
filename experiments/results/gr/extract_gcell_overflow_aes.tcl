# extract_gcell_overflow_aes.tcl
# Extract per-GCell congestion data after global routing for AES nangate45
# Independent ground truth for routing congestion
#
...
set DEF      "$ORFS/tools/OpenROAD/src/drt/test/aes_nangate45_preroute.def"
...
# --- Write segments ---
set seg_file "$OUT_DIR/aes_congested_segments.txt"
...
# --- Build JSON output ---
set json_file "$OUT_DIR/gcell_overflow_congested_aes_nangate45.json"
set fp [open $json_file w]

puts $fp "\{"
puts $fp "  \"design\": \"aes_nangate45\","
puts $fp "  \"grid_nx\": $nx,"
puts $fp "  \"grid_ny\": $ny,"
